...
const DARIJA_DICTIONARY = [
  ...
  { keywords: ['khobz', 'lkhobz','lkhbz', 'خبز', 'pain'], nameAr: 'خبز', nameFr: 'Pain', icon: '🍞', catId: 'daily' },
  ...
  { keywords: ['monada','monda', 'مونادا', 'مشروب غازي'], nameAr: 'مونادا', nameFr: 'Soda / Boisson', icon: '🥤', catId: 'cafe_smoke' },
  ...
  { keywords: ['sanecroi', 'snkrwa','sanikerwa','sanekra', 'sanicross', 'ساني كروا'], nameAr: 'سانيكروا', nameFr: 'Désinfectant sol', icon: '🧹', catId: 'fixed' },
  ...
  { keywords: ['oulways','Olwyz','Always', 'olwyaz', 'always', 'فوط صحية'], nameAr: 'فوط صحية', nameFr: 'Serviettes hygiéniques', icon: '🌸', catId: 'health' },
