...
function exportPDF() {
  ...
  const html = '<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="UTF-8"><title>تقرير ' + monthLabel + ' ' + curYear + '</title>'
    ...
    + '</tbody></table>'
    + '<div class="footer">Créé par BELMOUFADAL Abderrahim — Tadbir v4.4.2 — ' + new Date().toLocaleDateString() + '</div>'
    + '</body></html>';
...
function _buildXLSX() {
  ...
  var credit = 'Créé par BELMOUFADAL Abderrahim — Tadbir v4.4.2';
